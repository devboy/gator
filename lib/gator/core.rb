...
require File.expand_path( File.dirname(__FILE__) + '/core/io/configuration_file_loader' )
require File.expand_path( File.dirname(__FILE__) + '/core/io/project_file_loader' )
